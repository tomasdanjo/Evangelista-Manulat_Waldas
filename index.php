            ...
            if ($row) { 
                while ($res = mysqli_fetch_assoc($row)) {
                    echo'
                            ...
                            echo '</br><button class="btnSend" data-bs-toggle="modal" data-bs-target="#transferMoney'.$res["wallet_id"].'">Transfer Funds</button>';
                            echo '<span style="margin-left:10px"><button class="btnSend" data-bs-toggle="modal" data-bs-target="#sendMoney'.$res["wallet_id"].'">Send Money</button></span>';
                            echo '</h2>
                            </div>
                            <div class="space"></div>
                        </div>
